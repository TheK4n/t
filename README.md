...
```sh
go install github.com/thek4n/t/cmd/t@v1.1.4
```

### Download binary
```sh
wget https://github.com/TheK4n/t/releases/download/v1.1.4/t_v1.1.4_linux_amd64.tar.gz
tar xzf t_v1.1.4_linux_amd64.tar.gz
```
...
```sh
go install --tags=tsqlite github.com/thek4n/t/cmd/t@v1.1.4
t -v  # v1.1.4-sqlite
```
