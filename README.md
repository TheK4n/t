...
```sh
go install github.com/thek4n/t/cmd/t@v1.2.0
```

### Download binary
```sh
wget https://github.com/TheK4n/t/releases/download/v1.2.0/t_v1.2.0_linux_amd64.tar.gz
tar xzf t_v1.2.0_linux_amd64.tar.gz
```
...
```sh
go install --tags=tsqlite github.com/thek4n/t/cmd/t@v1.2.0
t -v  # v1.2.0-sqlite
```
