...
```sh
go install github.com/thek4n/t/cmd/t@v0.2.2
```

### Download binary
```sh
wget https://github.com/TheK4n/t/releases/download/v0.2.2/t_v0.2.2_linux_amd64.tar.gz
tar xzf t_v0.2.2_linux_amd64.tar.gz
```
