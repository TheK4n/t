...
func initTaskStorage(namespace string) storage.TasksStorage {
	...
	_, err = db.Exec("CREATE TABLE IF NOT EXISTS tasks(name varchar(90) primary key, namespace varchar(30) not null, born timestamp default CURRENT_TIMESTAMP not null, content text);")
